...
def readdir(rootdir):
    ...
    # adict = {"Ô": "У", "Ö": "Ц", "Æ": "Ж", "Ý": "Э", "Í": "Н", "Ã": "Г", "Ø": "Ш", "¯": "Ү", "Ç": "З", "Ê": "К", "Ú": "Ъ", "Å": "Е", "Ù": "Щ", "É": "Й", "Û": "Ы", "Á": "Б", "ª": "Ө", "À": "А", "Õ": "Х", "Ð": "Р", "Î": "О", "Ë": "Л", "Ä": "Д",
    # "Ï": "П", "ß": "Я", "×": "Ч", "¨": "Ё", "Ñ": "С", "Ì": "М", "È": "И", "Ò": "Т", "Ü": "Ь", "Â": "В", "Þ": "Ю", "ô": "ф", "ö": "ц", "ó": "у", "æ": "ж", "ý": "э", "í": "н", "ã": "г", "ø": "ш", "¿": "ү", "ç": "з", "ê": "к", "ú": "ъ", "å":
    # "е", "ù": "щ", "é": "й", "û": "ы", "á": "б", "º": "ө", "à": "а", "õ": "х", "ð": "р", "î": "о", "ë": "л", "ä": "д", "ï": "п", "ÿ": "я", "÷": "ч", "¸": "ё", "ñ": "с", "ì": "м", "è": "и", "ò": "т", "ü": "ь", "â": "в", "þ": "ю"}
    wtx = xlsxwriter.Workbook("F:\博士工作\导师任务\新建文件夹\汉文-新蒙文句子\\corpus1-new.xlsx")  # 在指定目录下创建一个excle
    sheet = wtx.add_worksheet("西里尔1")  # 新建一个sheet
        ...
        for filename in filenames:  # 将文件夹下所有文件写入Excel
            ...
            #f = open(abspath, 'r')
                   ...
                   # for key, value in adict.items():
                    ...
                    #if isEmpty(lineC) and isEmpty(lineM):
                        #break
...
readdir('F:\博士工作\导师任务\新建文件夹\汉文-新蒙文句子')
